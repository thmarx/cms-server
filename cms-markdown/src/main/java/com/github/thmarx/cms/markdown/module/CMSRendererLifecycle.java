...
@Slf4j
public class CMSRendererLifecycle extends ModuleLifeCycleExtension<CMSModuleContext, CMSRequestContext> {

	public static CMSMarkdownRenderer RENDERER;
	...
	public void activate() {
		...
		RENDERER = new CMSMarkdownRenderer();
	}
