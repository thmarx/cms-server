...
public class VariantTest {
    ...
    @Test
    void variant_is_selectable_in_preview(Page page) {
        page.navigate("http://localhost:2020?preview=preview&variant=summer");
        Assertions.assertThat(page.locator("title").innerText()).isEqualTo("Summer time");
    }
    
    @Test
    void variant_is_not_selectable_without_preview(Page page) {
        page.navigate("http://localhost:2020?variant=summer");
