...
function getUTCDateTimeFromInput(inputElement: HTMLInputElement) {
...
function utcToLocalDateInputValue(utcString: string) {
	const date = new Date(utcString);
	if (isNaN(date.getTime())) return "";
...
function getUTCDateFromInput(inputElement: HTMLInputElement) {
...
export { 
    ...
    getUTCDateTimeFromInput, 
    utcToLocalDateInputValue,
    getUTCDateFromInput};
