...
const listFiles = async (options : any) => {
	var data = {
		method: "files.list",
		parameters: options
	}
...
const deleteFolder = async (options : any) => {
	var data = {
		method: "files.delete",
		parameters: options
	}
...
const createFolder = async (options : any) => {
	var data = {
...
const createFile = async (options : any) => {
	var data = {
		method: "files.create",
		parameters: options
	}
...
const renameFile = async (options : any) => {
	var data = {
		method: "files.rename",
		parameters: options
	}
