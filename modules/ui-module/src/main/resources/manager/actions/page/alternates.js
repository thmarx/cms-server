...
import { addAlternate, getAlternates, removeAlternate } from '@cms/modules/rpc/rpc-alternates.js';
...
function createAlternatesTable(alternates) {
...
function createAlternateRow(alternate) {
...
function actionButtons(alternate) {
